...
export const aboutCardInfo = [
  ...
  },
  {
    ...
    description: 'Waste collected by the fisher community is sent to recyclers with a unique 6-digit tag for traceability.<br/><br/> As the waste is processed, it is tracked through each stage to its final destination. Enaleia supports a circular economy — learn more about product tracing with the example below:<br></br><a href="https://enaleia-hub.com/products/3411" style="font-weight: bold">Kayak by Enaleia x Nelo</a>',
  },
  {
    image: 'octopus',
