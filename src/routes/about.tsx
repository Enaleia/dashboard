  ...
  return (
    <main className='flex flex-col justify-center items-center gap-14 md:gap-24 m-auto pt-0 pb-20 px-6 md:pb-32 md:pt-16 max-w-[1500px]'>  
      ...
      <section className='text-center mx-4 md:mx-16'>
        ...
        <p className='w-full font-extralight text-base md:text-lg tracking-tight leading-tight md:leading-tight md:px-48'>{hubFlowSectionDescription}</p>
        ...
        <div className='relative w-full overflow-hidden rounded-3xl'>
          ...
          <div className='absolute inset-0 flex flex-col md:flex-row items-start justify-start md:justify-between p-4 pt-12 md:p-10'>
            <div className='md:w-[75%]'>
              ...
              <p className='font-extralight text-base md-text-xl tracking-tight leading-tight md:leading-tight py-2'>{collabSectionDescription1}</p>
              <p className='font-extralight text-base md-text-xl tracking-tight leading-tight md:leading-tight py-2'>{collabSectionDescription2}</p>
            </div>
