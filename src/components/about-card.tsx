...
const AboutCard = ({ image, title, description }: AboutCardProps) => {
  return (
    <article className="flex flex-col gap-4 md:gap-2 w-full border border-black rounded-3xl p-4 text-left">
      <img src={`/Sealife/${image}.svg`} alt={`illustration of ${image}`}/>
