        ...
        <TableBody>
          {tableData.map((location) => (
            ...
            >
              ...
              <TableCell className="p-0"><div className="mb-2 px-8 py-5 border-y border-black flex gap-2"><img src={`/flag_${location.country}.svg`} alt="country flag"/><span>{location.country}</span></div></TableCell>
